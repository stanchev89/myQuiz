...
export const ANSWER_IS_CLICKED = `${questionsNamespace} Answer Is Clicked`;
...
export const answerIsClicked = createAction(ANSWER_IS_CLICKED,props<{answerIsClicked:boolean}>());